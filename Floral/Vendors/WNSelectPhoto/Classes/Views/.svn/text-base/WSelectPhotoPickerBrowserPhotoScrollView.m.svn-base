//
//  WSelectPhotoPickerBrowserPhotoScrollView.m
//  WNSelectPhoto
//
...
@interface WSelectPhotoPickerBrowserPhotoScrollView ()<UIActionSheetDelegate> {
    WSelectPhotoPickerBrowserPhotoView *_tapView; // for background taps
    WSelectPhotoPickerBrowserPhotoImageView *_photoImageView;
}
...
@implementation WSelectPhotoPickerBrowserPhotoScrollView
...
- (id)init{
    if ((self = [super init])) {
        ...
        _tapView = [[WSelectPhotoPickerBrowserPhotoView alloc] initWithFrame:self.bounds];
        ...
        // Image view
        _photoImageView = [[WSelectPhotoPickerBrowserPhotoImageView alloc] initWithFrame:CGRectZero];
...
- (void)setPhoto:(WSelectPhotoAssets *)photo{
    _photo = photo;
