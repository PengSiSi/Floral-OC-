//
//  WSelectPhotoPickerGroupTableViewCell.m
//  WNSelectPhoto
//
...
@interface WSelectPhotoPickerGroupTableViewCell ()
...
@implementation WSelectPhotoPickerGroupTableViewCell
...
- (void)setGroup:(WSelectPhotoPickerGroup *)group{
    _group = group;
