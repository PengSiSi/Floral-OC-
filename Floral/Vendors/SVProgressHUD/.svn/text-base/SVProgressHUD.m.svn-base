...
+ (void)showInfoWithStatus:(NSString *)status duration:(NSTimeInterval)duration{
    ...
    [self showImage_2:[self sharedView].infoImage status:status duration:duration];
}
...
+ (void)showSuccessWithStatus:(NSString *)status duration:(NSTimeInterval)duration{
    ...
    [self showImage_2:[self sharedView].successImage status:status duration:duration];
}
...
+ (void)showErrorWithStatus:(NSString *)status duration:(NSTimeInterval)duration{
    ...
    [self showImage_2:[self sharedView].errorImage status:status duration:duration];
}
...
+(void)showImage_2:(UIImage *)image status:(NSString *)status duration:(NSTimeInterval)duration{
